...
This repository contains both a [link metadata ontology](links.ttl) and [a
specification](solid-storage-specification/) on how to use it in a [solid](https://solidproject.org/)
storage server.
